...
export function BrowseContainer({ slides }) {
  ...
  useEffect(() => {
    const fuse = new Fuse(slideRows, {
      keys: [{ name: 'data.title', weight: 2 }, 'data.description', 'data.title', 'data.genre']
    });
  ...
  return profile.displayName ? (
    ...
    <SelectProfileContainer slides={slides} user={user} setProfile={setProfile}></SelectProfileContainer>
  );
}
