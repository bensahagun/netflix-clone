  ...
  it('renders the basic <Header /> without a background', () => {
    const { container, getByText, queryByTestId } = render(
      <Header bg={false}>
        <Header.Frame>
          <Router>
            <Header.Logo to='/' src='/logo.svg' alt='Netflix'></Header.Logo>
    ...
    const { container, getByText, getByTestId } = render(
      <Header src='joker1' dontShowOnSmallViewPort>
        <Header.Frame>
          ...
          <Header.Group>
            <Header.Search searchTerm='Joker' setSearchTerm={() => {}}></Header.Search>
            <Header.Profile>
              <Header.Picture src='/images/ben.png' />
              <Header.Dropdown>
                <Header.Group>
                  <Header.Picture src='/images/ben.png' />
                  <Header.TextLink>Ben Sahagun</Header.TextLink>
                </Header.Group>
                <Header.Group>
